...
Key_t Matrix[NUM_LAYER][NUM_ROW][NUM_COL] = {
  ...
  {
    {KEY_BL_OFF,   KEY_NONE,      KEY_NONE, KEY_NONE, KEY_NONE, KEY_BL_BRIGHT_DOWN, KEY_BL_BRIGHT_UP,  KEY_NONE,   KEY_NONE, KEY_BL_NEXT,     KEY_NONE,      KEY_BL_SPEED_DOWN,       KEY_BL_SPEED_UP,     KEY_SAVE_AS_IDLE},
